...
def gen_report(request, data, memo):
    ...
    table_data = [
        [
            ...
            Paragraph("CARATS", company_style),
            Paragraph("Rate per Crt HK$/US$", company_style),
            Paragraph("PENDING", company_style),
            Paragraph("RETURN", company_style),
            Paragraph("CARATS SOLD", company_style),
            Paragraph("REMARK", company_style),
        ]
    ]
